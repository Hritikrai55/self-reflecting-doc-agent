...
- **Planning** demonstrates the agent's ability to reason about *what* needs to be done, not just *how* — the core of autonomy.
...
```json
{
  ...
  "task_plan": [
    {"step_number": 1, "action": "research", "description": "...", "status": "completed"},
    {"step_number": 2, "action": "outline", "description": "...", "status": "completed"}
  ],
  "reflection": {
    "passed": true,
    "score": 85,
...
5. **Structured responses** — The full task plan, assumptions, and reflection are returned so the consumer can see *how* the agent reasoned, not just the final output.
